...
def validation(epoch):
    ...
    #logger.scalar_summary("validation on validation set", validation_loss, epoch)
    #logger.scalar_summary("accuracy on validation set", 100. * correct / len(val_loader.dataset), epoch)
...
def trainValidation(epoch):
    ...
    logger.scalar_summary("validation on training set", validation_loss, epoch)
    logger.scalar_summary("accuracy on training set", 100. * correct / len(train_loader.dataset), epoch)
    # log_value("validation loss", validation_loss, epoch)
    # log_value("accuracy", 100. * correct / len(train_loader.dataset), epoch)
