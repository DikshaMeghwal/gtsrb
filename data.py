...
data_transforms5 = transforms.Compose([
...
data_transforms6 = transforms.Compose([
    transforms.RandomApply([transforms.RandomCrop(32, padding=4) , transforms.RandomHorizontalFlip(p=0.5),transforms.RandomVerticalFlip(p=0.5),transforms.RandomRotation(90)] , p=0.75),
    transforms.Scale((48, 48)),
    transforms.ToTensor(),
    transforms.Normalize((0.3337, 0.3064, 0.3171), ( 0.2672, 0.2564, 0.2629))
])
